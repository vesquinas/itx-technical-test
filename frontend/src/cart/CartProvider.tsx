 ...
 * Estado de la cesta.
 *
 * La API es la fuente de la verdad: `POST /api/cart` responde con el numero de
 * articulos y ese es el valor que se muestra y se persiste. No se lleva una
 * cuenta propia en el cliente, porque entonces habria dos verdades que podrian
 * discrepar.
 *
 * El estado inicial se lee de `localStorage` de forma perezosa, pasando la
 * funcion a `useState`, para no tocar el almacenamiento en cada renderizado.
 */
